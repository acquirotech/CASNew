...
public class AcqMerchantNewModel {
	...
	@NotNull
	@Pattern(regexp="^[a-zA-Z\\s]{2,50}$",message="Invalid Branch State")
	private String PersonalUserState;
	
	@NotNull
	@Pattern(regexp="^[a-zA-Z\\s]{2,50}$",message="Invalid Branch City")
	private String PersonalUserCity;
	
	@NotNull
	@Pattern(regexp="^[0-9]{6,6}$",message="Invalid Branch Pin Code")
	...
	@Pattern(regexp="^[a-zA-Z0-9\\s]{0,50}$",message="Invalid Account Name")
	private String chequeBank;
	
	@Pattern(regexp="^[0-9]{0,8}[\\.]{0,1}[0-9]{0,2}?$",message="Invalid Cash Amount")	
	private String cashAmount;
	
	@Pattern(regexp="^[0-9]{0,8}[\\.]{0,1}[0-9]{0,2}?$",message="Invalid Neft Amount")	
	...
	@Pattern(regexp="^[0-9]{0,15}$",message="Invalid Neft RefNo")
