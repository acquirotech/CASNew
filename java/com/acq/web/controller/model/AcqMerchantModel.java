...
public class AcqMerchantModel {
	...
	@NotNull
	@Size(min=2,max=100, message="Invalid Address1")
	private String Address1;
	
	@NotNull
	@Size(min=2,max=100, message="Invalid Address2")
	...
	@NotNull
	@Pattern(regexp="^[a-zA-Z\\s]{3,12}$",message="Invalid Verification Status")
