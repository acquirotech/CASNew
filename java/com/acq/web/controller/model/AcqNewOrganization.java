...
public class AcqNewOrganization {
	...
	public String getAddOrgPinCode() {
		return AddOrgPinCode;
	}

	public void setAddOrgPinCode(String addOrgPinCode) {
		AddOrgPinCode = addOrgPinCode;
	}
