...
public class AcqNewUpdateOrgModel {
	...
	@NotNull
	@Pattern(regexp="^[0-9]{6,6}$",message="Invalid Org Pin Code")
	private String UpdOrgPinCode;
	...
	public String getUpdOrgPinCode() {
		return UpdOrgPinCode;
	}

	public void setUpdOrgPinCode(String updOrgPinCode) {
		UpdOrgPinCode = updOrgPinCode;
	}
