        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Generate Commission Report</h3>
            </div>
            <form role="form" method="get" action="<c:url value='downloadcardCommisionProcedureFromAndToDate'/>" target="_blank">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-5">
