                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Complaint Log List</h2>   
                                   <!--  <button type="button" class="btn-filter nav navbar-right panel_toolbox" data-toggle="modal" data-target=".filter-detail-popup"><i class="fa fa-filter" aria-hidden="true"></i>Filters</button>                                    
                                            ...
                                            <c:forEach var="allRowData" items="${basicMerchantDetails}">
                                                ...
                                                <c:if test="${not empty merchantvar}">
                                                    ...
                                                    <tr class="even pointer">
                                                       ...
                                                       <td class=" "><form id="ShowMerchantDetails" action="<c:url value='callerDetails' />"  method='GET' >
                                                        <input type="hidden" name="callerId" id="callerId" value='<c:out value="${allRowData['id']}"/>' />
                                                        <button type="submit" class="btn-submit" <c:if test="${empRole == '12'}">style="display:none;"</c:if>>More</button>
                                                         <button type="button" class="btn-delete" onclick='return deleteEmp("${allRowData.id}")' >Delete</button>                                             
