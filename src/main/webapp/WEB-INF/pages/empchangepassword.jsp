...
<% if(!(session.getAttribute("empRole").equals("2")||session.getAttribute("empRole").equals("12")||session.getAttribute("empRole").equals("3")||session.getAttribute("empRole").equals("4"))){
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control" data-clear-btn="true" name="name" id="name" value="${empName}" required="true" minlength="2" maxlength=100 readonly="readonly" />
                                            </div>
                                        </div>
                                     <div class="form-group">
                                    	...
                                    	<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <input type="text" class="form-control" data-clear-btn="true" name="phone" id="phone" value="${empPhone}" required="true" onkeypress='return event.charCode >= 48 && event.charCode <= 57' digits="true"/>
                                          </div>
                                        </div>
									  ...
									  <option <c:if test="${RowData['executiveId'] == allMerchantDetails['executiveId']}">selected</c:if> value="<c:out value="${RowData['executiveId']}"/>"><c:out value="${RowData['executiveName']}"/></option> 									  
                                          ...
                                          <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                               <a href="<c:url value='emplockunlock' />" class="btn btn-primary">Cancel</a>
                                                <button type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="btn btn-success" onclick="return getemplock();" class="ui-btn ui-icon-check ui-btn-icon-left ui-shadow-icon ui-btn-b ui-corner-all" id="AddOrgSub" name="AddOrgSub">Submit</button>
                                            </div>
                                        </div>                                       
                                </div>
                            </div>                            
