        ...
        <div class="col-md-12">
          <div class="box box-primary">
              ...
              <div class="box-header with-border">
                <h3 class="box-title">Card Risk Transaction List</h3>
                <div class="box-tools">
                  ...
                  <tbody>
                    ...
                    <c:forEach var="allRowData" items="${riskManagementList}">											
                                        	<tr class="even pointer">
												...
												<td class=" ">
													<button type="submit" class="btn btn-success btn-xs" data-toggle="modal" data-target=".Transaction-detail-popup" onclick='return setTxnDetails("${allRowData.merchantName}","${allRowData.orgName}","${allRowData.userName}","${allRowData.id}","${allRowData.custEmail}","${allRowData.amount}","${allRowData.status}","${allRowData.dateTime}","${allRowData.custPhone}","${allRowData.statusDescription}","${allRowData.txnType}","${allRowData.cardHolderName}","${allRowData.cardPanNo}","${allRowData.cardType}","${allRowData.cardExpDate}","${allRowData.rrNo}","${allRowData.referenceNo}","${allRowData.terminalId}","${allRowData.batchNo}","${allRowData.authCode}","${allRowData.issuerAuthCode}","${allRowData.ipAddress}","${allRowData.imeiNo}","${allRowData.latitude}","${allRowData.longitude}","${allRowData.stan}","${allRowData.riskDescription}")'>View Details</button>	
													<button type="submit" class="btn btn-success btn-xs" onclick='return updateStatus("${allRowData.riskId}","${allRowData.txnType}");'>Update</button></td>	
											</tr>
											</c:forEach>
